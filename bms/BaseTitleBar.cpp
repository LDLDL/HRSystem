...
BaseTitleBar::BaseTitleBar(QWidget *parent)
    : QWidget(parent), m_colorR(153), m_colorG(153), m_colorB(153),
      m_isPressed(false), m_buttonType(MIN_MAX_BUTTON) {
  // 初始化;
  initControl();
  initConnections();
...
// 设置标题栏长度;
void BaseTitleBar::setTitleWidth(int width) { this->setFixedWidth(width); }
...
// 以下为按钮操作响应的槽;
void BaseTitleBar::onButtonMinClicked() { emit signalButtonMinClicked(); }
...
void BaseTitleBar::onButtonCloseClicked() { emit signalButtonCloseClicked(); }
